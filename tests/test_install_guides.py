...
EXCEPTIONS: dict[str, dict[str, str]] = {
    ...
    "nl": {
        ...
        "options.step.settings.data.max_precondition": ("Maximale vooruitlooptijd (minuten)"),
        "options.step.settings.data.precipitation_states": ("Toestanden die als neerslag tellen"),
        "options.step.settings.data.require_awake": ("Iemand die thuis is moet wakker zijn"),
        "options.step.settings.data.season_source": ("Herkomst seizoen"),
        ...
        "options.step.zone.data.heat_target": ("Doeltemperatuur verwarmen"),
        ...
        "selector.when_done.options.keep": ("Deze wijzigingen bewaren en teruggaan"),
    },
    "de": {
        "options.step.circuit.data.allow_fan_only_during_conflict": (
        ...
        "options.step.settings.data.guest_start": ("Gästemodus ab"),
        "options.step.settings.data.heating_layout": ("Heizungsanlage"),
        "options.step.settings.data.holiday_keyword": ("Wort, das Urlaub kennzeichnet"),
    ...
    "es": {
        ...
        "options.step.quiets.data.quiet": ("Franja"),
    ...
    "fr": {
        ...
        "options.step.quiets.data.quiet": ("Plage"),
        ...
        "options.step.settings.data.shadow_mode": ("Mode ombre"),
    ...
    "ar": {
        ...
        "options.step.opening.data.entity_id": ("المستشعر"),
        ...
        "options.step.resident.data.sleep_entity": ("مستشعر النوم"),
