...
class Plan:
    ...
    Wordt ronde na ronde meegedragen zolang het apparaat niet draait, zodat één
    ronde met een andere uit-reden de rust niet vergeet.

    Carried round after round while the appliance stays off, so one round with
